...
hd.setAttribute("style","background-color:grey;color:midnightblue;text-align:center")
...
// using for each to access all images in api
...
ah.innerText="another way of accessing products"
